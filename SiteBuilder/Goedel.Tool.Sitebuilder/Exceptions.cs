...
//  This file was automatically generated at 10/24/2025 11:19:13 AM
//   
...
/// </summary>
[global::System.Serializable]
public partial class Invalid : Internal {
	...
	/// <param name="inner">Inner Exception</param>	
	/// <param name="args">Optional list of parameterized arguments.</param>
	public Invalid  (string description=null, System.Exception inner=null,
		params object[] args) : 
			base (ExceptionFormatDelegate(description, Templates,
				null, args), inner) {
		}
    ...
    static System.Exception _Throw(object reasons) => new Invalid(args:reasons) ;
