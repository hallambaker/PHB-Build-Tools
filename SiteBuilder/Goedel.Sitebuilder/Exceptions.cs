...
//  This file was automatically generated at 11/12/2025 11:35:35 AM
//   
...
/// <summary>
/// XML nesting incorrect.
/// </summary>
[global::System.Serializable]
public partial class NestingIncorrect : Internal {
	...
	/// <param name="inner">Inner Exception</param>	
	/// <param name="args">Optional list of parameterized arguments.</param>
	public NestingIncorrect  (string description=null, System.Exception inner=null,
		params object[] args) : 
			base (ExceptionFormatDelegate(description, Templates,
				null, args), inner) {
		}
    ...
    static System.Exception _Throw(object reasons) => new NestingIncorrect(args:reasons) ;
