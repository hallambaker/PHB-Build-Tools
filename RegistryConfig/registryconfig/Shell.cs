...
//  This file was automatically generated at 11/12/2025 11:35:39 AM
//   
...
public class _CommandShell : global::Goedel.Command.DispatchShell {
	...
	public virtual void RegistryGenerate ( RegistryGenerate Options) {
        ...
        Goedel.Tool.RegistryConfig.ConfigItems Parse = new () {
			};
		...
		if (Options.Generate.Text != null) {
			...
			Goedel.Tool.RegistryConfig.GenerateCS Script = new () { 
