...
namespace Goedel.Trojan.Script {
    public partial class CommandLineInterpreter : CommandLineInterpreterBase {
        ...
        static CommandLineInterpreter () {
            ...
            if (OperatingSystem.Platform == PlatformID.Unix |
				...
				Description = "Graphical Interface Builder";

			Entries = new  SortedDictionary<string, DescribeCommand> () {
				{"about", DescribeAbout },
				{"gtk", _Generate._DescribeCommand },
				{"help", DescribeHelp }
				}; // End Entries
    ...
    public class _Generate : Goedel.Command.Dispatch  {
		...
		public virtual ExistingFile GUISchema {
			get => _Data[1] as ExistingFile;
			set => _Data[1]  = value;
			}

		public virtual string _GUISchema {
