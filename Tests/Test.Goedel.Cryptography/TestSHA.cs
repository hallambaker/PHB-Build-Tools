    ...
    public partial class TestCryptography {
        ...
        List<TestVectorSHA> TestVectors_SHA_NIST = new List<TestVectorSHA>() {
            ...
            new TestVectorSHA() {
                ...
                Message = "abc",
                Digest =  ("A9993E36 4706816A BA3E2571 7850C26C 9CD0D89D").FromBase16String(),
                },
            // Test Case 1
            new TestVectorSHA() {
                ID = CryptoAlgorithmID.SHA_1_DEPRECATED,
                Message = "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
                Digest =  ("84983E44 1C3BD26E BAAE4AA1 F95129E5 E54670F1").FromBase16String(),
                },
            ...
            new TestVectorSHA() {
                ...
                Digest =  ("BA7816BF 8F01CFEA 414140DE 5DAE2223" +
                            "B00361A3 96177A9C B410FF61 F20015AD").FromBase16String(),
                },
            // Test Case 1
            new TestVectorSHA() {
                ID = CryptoAlgorithmID.SHA_2_256,
                ...
                Digest =  ("248D6A61 D20638B8 E5C02693 0C3E6039" +
                            "A33CE459 64FF2167 F6ECEDD4 19DB06C1").FromBase16String(),
                },
            ...
            new TestVectorSHA() {
                ...
                Digest =  ("DDAF35A1 93617ABA CC417349 AE204131"
                    ...
                    +"36BA3C23 A3FEEBBD 454D4423 643CE80E 2A9AC94F A54CA49F").FromBase16String(),
                },
            // Test Case 1
            new TestVectorSHA() {
                ID = CryptoAlgorithmID.SHA_2_512,
                ...
                Digest =  ("8E959B75 DAE313DA 8CF4F728 14FC143F"
                    ...
                    +"331B99DE C4B5433A C7D329EE B6DD2654 5E96E55B 874BE909").FromBase16String(),
                },
            ...
            //    Message = "abc",
            //    Digest =  ("DDAF35A1 93617ABA CC417349 AE204131").FromBase16String(),
            //    },
            //// Test Case 1
            //new TestVectorSHA() {
            //    ID = CryptoAlgorithmID.SHA_2_512T128,
            //    Message = "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
            //    Digest =  ("8E959B75 DAE313DA 8CF4F728 14FC143F").FromBase16String(),
            //    },
            };
        ...
        // TEST: Add test in streaming mode
        }
