...
class Edwards448Point(EdwardsPoint):
    ...
    #Solve for x^2.
    def solve_x2(self,y):
        x2 = ((y*y-self.f1)/(self.d*y*y-self.f1))
        yy = (y*y-self.f1)
        zz = (self.d*y*y-self.f1)
...
rebase = Edwards448Point.decode (base, base_encode)
...
print ('d      {}'.format(base.d._Field__x))



secretkey = hexi("6c82a562cb808d10d632be89c8513ebf6c929f34ddfa8c9f63c9960ef6e348a3528c8a3fcc2f044e39a3fc5b94492f8f032e7549a20098f95b")
privkey2,pubkey = Ed448.keygen(secretkey)



publickey = hexi("5fd7449b59b461fd2ce787ec616ad46a1da1342485a70e1f8a0ea75d80e96778edf124769b46c7061bd6783df1e50f6cd1fa1abeafe8256180")
