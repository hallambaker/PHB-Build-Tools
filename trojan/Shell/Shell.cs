...
#pragma warning restore 219
					...
					Console.WriteLine ("    Generate a graphical user interface");
    ...
    public class _Generate : Goedel.Registry.Dispatch {
		...
		public ExistingFile			InputFile = new ExistingFile ("cmd");
		public ExistingFile			OutputFile = new ExistingFile ();
