...
/// </summary>
[global::System.Serializable]
public partial class UnknownOptionSet : ParserException {
	...
	/// <param name="inner">Inner Exception</param>	
	/// <param name="args">Optional list of parameterized arguments.</param>
	public UnknownOptionSet  (string description=null, System.Exception inner=null,
		params object[] args) : 
			base (ExceptionFormatDelegate(description, Templates,
				null, args), inner) {
		}
    ...
    static System.Exception _Throw(object reasons) => new UnknownOptionSet(args:reasons) ;
