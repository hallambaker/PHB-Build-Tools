...
REM Help Viewer 1.0
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Comodo Group Inc" /productName "Goedel Libraries" /mediaBookList "Goedel Portable Support Libraries"
...
REM Help Viewer 2.x
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation uninstall /vendor "Comodo Group Inc" /productName "Goedel Libraries" /bookList "Goedel Portable Support Libraries"
