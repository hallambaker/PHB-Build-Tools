...
//    public class Xml2RFCOutv2 {
//        TextWriter TextWriter;

//        public Xml2RFCOutv2(TextWriter TextWriter) => this.TextWriter = TextWriter;
...
//                                for (int Row = 0; Row < Table.Body.Count; Row++) {
//                                    TableRow TableRow = Table.Body[Row];
//                                    int Col = 0;
