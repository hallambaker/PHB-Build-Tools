...
namespace GoedelSchema {
    ...
    public abstract partial class _Choice {
        abstract public GoedelSchemaType _Tag ();
    ...
    public partial class Copyright : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.Copyright;
            }
    ...
    public partial class MITLicense : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.MITLicense;
            }
    ...
    public partial class BSD2License : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.BSD2License;
            }
    ...
    public partial class BSD3License : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.BSD3License;
            }
    ...
    public partial class ISCLicense : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.ISCLicense;
            }
    ...
    public partial class Apache2License : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.Apache2License;
            }
    ...
    public partial class OtherLicense : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.OtherLicense;
            }
    ...
    public partial class TopType : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.TopType;
            }
    ...
    public partial class Remark : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.Remark;
            }
    ...
    public partial class Options : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.Options;
            }
    ...
    public partial class OptionEntry : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.OptionEntry;
            }

		public override void _InitChildren (_Choice Parent) {
			Init (Parent);
			Occurs._InitChildren (this);
			}

		public override void Serialize (StructureWriter Output, bool tag) {

			if (tag) {
				Output.StartElement ("OptionEntry");
				}

	        Output.WriteId ("Name", Name.ToString());
	        Output.WriteId ("Type", Type.ToString());
	        Occurs.Serialize (Output, true);
			if (tag) {
				Output.EndElement ("OptionEntry");
				}			
			}
		}
    ...
    public partial class Single : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.Single;
            }
		...
		public override void Serialize (StructureWriter Output, bool tag) {
			...
			if (tag) {
				Output.StartElement ("Single");
				}

			if (tag) {
				Output.EndElement ("Single");
				}			
			}
		}
    ...
    public partial class Multiple : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.Multiple;
            }
    ...
    public partial class Choice : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.Choice;
            }
		...
		public override void Serialize (StructureWriter Output, bool tag) {
			...
			foreach (REF<_Choice> _e in Entries) {
				Output.WriteId ("Entries", _e.ToString());
				}
			Output.EndList ("");
			if (tag) {
    ...
    public partial class ChoiceREF : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.ChoiceREF;
            }
    ...
    public partial class REF : _Choice {
		...
		public override void Serialize (StructureWriter Output, bool tag) {
			...
			if (tag) {
				Output.StartElement ("REF");
				}

	        Output.WriteId ("Type", Type.ToString());
			if (tag) {
				Output.EndElement ("REF");
				}			
			}
		}
    ...
    public partial class String : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.String;
            }
    ...
    public partial class Integer : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.Integer;
            }
    ...
    public partial class Boolean : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType.Boolean;
            }
    ...
    class _Label : _Choice {
        ...
        public override GoedelSchemaType _Tag () {
            return GoedelSchemaType._Label;
            }
    ...
    public partial class GoedelSchema : Goedel.Registry.Parser{
        ...
        public static GoedelSchema Parse(string File, Goedel.Registry.Dispatch Options) {
            var Result = new GoedelSchema();
        ...
        public TYPE<GoedelSchema._Choice> TYPE__TopTypeType ;
        public TYPE<GoedelSchema._Choice> TYPE__TypeType ;
        public TYPE<GoedelSchema._Choice> TYPE__IdType ;
        public TYPE<GoedelSchema._Choice> TYPE__NamespaceType ;
        public TYPE<GoedelSchema._Choice> TYPE__ClassType ;
        public TYPE<GoedelSchema._Choice> TYPE__NameType ;
        public TYPE<GoedelSchema._Choice> TYPE__TokenType ;
        ...
        static GoedelSchema.GoedelSchemaType _Reserved(string Label) {
            switch (Label) {

                case "Copyright": return GoedelSchema.GoedelSchemaType.Copyright;
                case "MITLicense": return GoedelSchema.GoedelSchemaType.MITLicense;
                case "BSD2License": return GoedelSchema.GoedelSchemaType.BSD2License;
                case "BSD3License": return GoedelSchema.GoedelSchemaType.BSD3License;
                case "ISCLicense": return GoedelSchema.GoedelSchemaType.ISCLicense;
                case "Apache2License": return GoedelSchema.GoedelSchemaType.Apache2License;
                case "OtherLicense": return GoedelSchema.GoedelSchemaType.OtherLicense;
                case "Class": return GoedelSchema.GoedelSchemaType.Class;
                case "TopType": return GoedelSchema.GoedelSchemaType.TopType;
                case "Type": return GoedelSchema.GoedelSchemaType.Type;
                case "Entry": return GoedelSchema.GoedelSchemaType.Entry;
                case "Remark": return GoedelSchema.GoedelSchemaType.Remark;
                case "Options": return GoedelSchema.GoedelSchemaType.Options;
                case "OptionEntry": return GoedelSchema.GoedelSchemaType.OptionEntry;
                case "Single": return GoedelSchema.GoedelSchemaType.Single;
                case "Multiple": return GoedelSchema.GoedelSchemaType.Multiple;
                case "List": return GoedelSchema.GoedelSchemaType.List;
                case "Choice": return GoedelSchema.GoedelSchemaType.Choice;
                case "ChoiceREF": return GoedelSchema.GoedelSchemaType.ChoiceREF;
                case "ID": return GoedelSchema.GoedelSchemaType.ID;
                case "REF": return GoedelSchema.GoedelSchemaType.REF;
                case "Token": return GoedelSchema.GoedelSchemaType.Token;
                case "String": return GoedelSchema.GoedelSchemaType.String;
                case "Integer": return GoedelSchema.GoedelSchemaType.Integer;
                case "Text": return GoedelSchema.GoedelSchemaType.Text;
                case "Boolean": return GoedelSchema.GoedelSchemaType.Boolean;

                }
            return GoedelSchema.GoedelSchemaType._Bottom;
            }
                ...
                switch (State) {
                    ...
                    case StateCode._Choice:                //      LABEL Class | END
                        if (Token == TokenType.LABEL) {
                            GoedelSchema.GoedelSchemaType LabelType = _Reserved (Text);
                            if (false |
									(LabelType == GoedelSchema.GoedelSchemaType.Copyright) |
									(LabelType == GoedelSchema.GoedelSchemaType.Class)) {
                    ...
                    case StateCode.Copyright__Holder:
                        if (Token == TokenType.LABEL) {
                            ...
                            GoedelSchema.GoedelSchemaType LabelType = _Reserved (Text);
                            if ( false |
									(LabelType == GoedelSchema.GoedelSchemaType.MITLicense) |
									(LabelType == GoedelSchema.GoedelSchemaType.BSD2License) |
									(LabelType == GoedelSchema.GoedelSchemaType.BSD3License) |
									(LabelType == GoedelSchema.GoedelSchemaType.ISCLicense) |
									(LabelType == GoedelSchema.GoedelSchemaType.Apache2License) |
									(LabelType == GoedelSchema.GoedelSchemaType.OtherLicense) ) {
                                State = StateCode.Copyright__License;
                                Current_Cast.License = New_Choice(Text);
                                }
                            else {
                               throw new System.Exception("Parser Error Expected [MITLicense BSD2License BSD3License ISCLicense Apache2License OtherLicense ]");
                                }
                            break;
                            }
                        else throw new System.Exception("Parser Error Expected [MITLicense BSD2License BSD3License ISCLicense Apache2License OtherLicense ]");
                    ...
                    case StateCode.Class__Entries: 
						...
						// Parser transition for LIST $$$$$
                            ...
                            GoedelSchema.GoedelSchemaType LabelType = _Reserved (Text);
                            if ( false |
									(LabelType == GoedelSchema.GoedelSchemaType.TopType) |
									(LabelType == GoedelSchema.GoedelSchemaType.Type) ) {
                                Current_Cast.Entries.Add (New_Choice(Text));
                                }
                            else {
								throw new System.Exception("Parser Error Expected [TopType Type ]");
								}
							}
                        break;
                    ...
                    case StateCode.Entry__Name:
                        if (Token == TokenType.LABEL) {
                            ...
                            GoedelSchema.GoedelSchemaType LabelType = _Reserved (Text);
                            if ( false |
									(LabelType == GoedelSchema.GoedelSchemaType.List) |
									(LabelType == GoedelSchema.GoedelSchemaType.Choice) |
									(LabelType == GoedelSchema.GoedelSchemaType.ID) |
									(LabelType == GoedelSchema.GoedelSchemaType.REF) |
									(LabelType == GoedelSchema.GoedelSchemaType.Token) |
									(LabelType == GoedelSchema.GoedelSchemaType.String) |
									(LabelType == GoedelSchema.GoedelSchemaType.Text) |
									(LabelType == GoedelSchema.GoedelSchemaType.Integer) |
									(LabelType == GoedelSchema.GoedelSchemaType.Boolean) |
									(LabelType == GoedelSchema.GoedelSchemaType.ChoiceREF) |
									(LabelType == GoedelSchema.GoedelSchemaType.Options) |
									(LabelType == GoedelSchema.GoedelSchemaType.Remark) ) {
                        ...
                        else throw new System.Exception("Parser Error Expected [List Choice ID REF Token String Text Integer Boolean ChoiceREF Options Remark ]");
                    ...
                    case StateCode.OptionEntry__Type:
                        if (Token == TokenType.LABEL) {
                            ...
                            GoedelSchema.GoedelSchemaType LabelType = _Reserved (Text);
                            if ( false |
									(LabelType == GoedelSchema.GoedelSchemaType.Single) |
									(LabelType == GoedelSchema.GoedelSchemaType.Multiple) ) {
                                State = StateCode.OptionEntry__Occurs;
                                Current_Cast.Occurs = New_Choice(Text);
                                }
                            else {
                               throw new System.Exception("Parser Error Expected [Single Multiple ]");
                                }
                            break;
                            }
                        else throw new System.Exception("Parser Error Expected [Single Multiple ]");
                    ...
                    case StateCode.List_Start:
                        ...
                        else throw new System.Exception("Parser Error Expected [Choice ID REF Token String Text Integer ]");
