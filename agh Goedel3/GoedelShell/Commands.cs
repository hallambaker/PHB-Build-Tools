...
namespace Goedel.Shell.Command {
    class _Main {
...
#pragma warning restore 219
    ...
    public class _Command {
		...
		public virtual void Schema ( Schema Options
            ...
            Goedel.Tool.Schema.Goedel Parse = new Goedel.Tool.Schema.Goedel();
			...
			if (Options.GenerateCS.Text != null) {
				...
				using (Stream outputStream =
					...
					using (TextWriter OutputWriter = new StreamWriter(outputStream, Encoding.UTF8)) {
						...
						Goedel.Tool.Schema.GenerateParser Script = new Goedel.Tool.Schema.GenerateParser (OutputWriter);
